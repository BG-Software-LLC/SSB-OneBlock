...
import net.minecraft.server.v1_13_R1.ArgumentBlock;
import net.minecraft.server.v1_13_R1.ArgumentNBTTag;
import net.minecraft.server.v1_13_R1.ArgumentTileLocation;
    ...
    public void setBlock(Location location, Material type, byte data, String nbt) {
        ...
        if(nbt != null) {
            try {
                ...
                ArgumentTileLocation tileLocation = new ArgumentTileLocation(argumentBlock.b(), argumentBlock.a().keySet(), argumentBlock.c());
